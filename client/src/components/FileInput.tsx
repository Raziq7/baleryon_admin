...
function FileInput({
  ...
  const [croppedImages, setCroppedImages] = useState<string[]>(initialImages); // 👈 preload images
  ...
  useEffect(() => {
    setCroppedImages(initialImages); // 👈 reset when initialImages changes
  }, [initialImages]);
